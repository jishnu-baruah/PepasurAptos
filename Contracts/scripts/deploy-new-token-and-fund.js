...
async function main() {
  console.log("🚀 Deploying New FlowToken and Funding Faucet");
  console.log("===============================================");
  ...
  try {
    // Deploy new FlowToken contract
    console.log("\n📄 Deploying new FlowToken contract...");
    ...
    console.log("✅ New FlowToken deployed to:", flowTokenAddress);
    ...
    console.log("\n🔗 Contract Links:");
    console.log("- New FlowToken: https://evm-testnet.flowscan.io/address/" + flowTokenAddress);
