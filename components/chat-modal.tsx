...
export default function ChatModal({ onComplete }: ChatModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-50 p-2 sm:p-4 gaming-bg">
      ...
      <Card className="w-full max-w-4xl h-[90vh] sm:h-[600px] bg-[#0A0A0A]/95 backdrop-blur-sm border-2 border-[#4A8C4A] flex flex-col relative overflow-hidden">
        ...
        <div className="flex-1 flex flex-col lg:flex-row">
          {activeTab === 'chat' ? (
            <>
              {/* Chat Messages */}
              <div className="flex-1 p-3 sm:p-6 overflow-y-auto space-y-2 sm:space-y-3 bg-[#111111]/50">
                {messages.map((msg, i) => (
              ...
              {/* Quick Task Panel */}
              <div className="w-full lg:w-80 p-3 sm:p-4 border-t-2 lg:border-t-0 lg:border-l-2 border-[#4A8C4A] bg-[#0F0F0F]/80">
        ...
        {/* Enhanced Input Area */}
        <div className="p-3 sm:p-6 border-t-2 border-[#4A8C4A] bg-gradient-to-r from-[#0A0A0A] to-[#1A1A1A]">
