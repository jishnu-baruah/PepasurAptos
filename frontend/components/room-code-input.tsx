...
export default function RoomCodeInput({ onJoin, onCancel }: RoomCodeInputProps) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 gaming-bg">
      <Card className="w-full max-w-md p-6 bg-[#111111]/90 backdrop-blur-sm border border-[#2a2a2a]">
        <div className="text-center space-y-6">
          <div>
            <h2 className="text-2xl font-press-start text-white mb-2 pixel-text-3d-glow">JOIN GAME</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <input
                ...
                placeholder="ABC123"
                className="w-full px-4 py-3 text-center text-2xl font-press-start bg-[#1a1a1a] border border-[#333] text-white rounded-none focus:outline-none focus:border-blue-500 tracking-widest"
                maxLength={6}
                autoFocus
              />
